    ...
    if($cus['usersId']  == $customer_id):
        ...
        <section class="mt-4">
            ...
            <div class="editSellerProfile-form">
                <form action="controller/inc/edit-customer-profile.inc.php" method="post">
                    <h2>Edit customer's profile</h2>
                    <hr>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="surname" value="<?php echo $cus['usersSurname'] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="street" value="<?php echo $cus['street'] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="houseNo" value="<?php echo $cus['houseNo'] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="post" value="<?php echo $cus['post'] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="postNo" value="<?php echo $cus['postNo'] ?>">
                        </div>
                    </div>
                        <div class="form-group">
                            <div class="input-group">
